#!/usr/bin/env python3
"""
Check if OpenClaw Memory System is properly installed
"""
...
def check_core_modules():
    ...
    modules = [
        "core.vector_memory_db",
        "core.procedural_memory",
...
def main():
    """Run all checks"""
    print("\n" + "="*60)
    print("OpenClaw Memory System - Installation Check")
    print("="*60)
